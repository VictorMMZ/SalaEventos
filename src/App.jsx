...
function App() {
    ...
    <div>
      ...
      <main id="inicio">
        ...
        <section className="hero">
          ...
          <span className="star yellow" style={{ left: "4%", top: "30%" }}>★</span>
          <span className="star pink" style={{ right: "7%", top: "20%" }}>✦</span>
          <span className="star blue" style={{ right: "12%", bottom: "20%" }}>★</span>
          ...
          <div className="container hero-content">
            ...
            <p>
              El lugar donde la diversión, la imaginación
              y los mejores momentos se hacen realidad.
            </p>

            <div className="hero-buttons">
              <a href="#reserva" className="btn btn-pink">🎈 Reservar mi fecha</a>
              <a href="#salas" className="btn btn-white">🏰 Conocer salas</a>
            </div>
        ...
        <section id="salas" className="section rooms">
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>Elige el espacio perfecto para que los pequeños disfruten de un día inolvidable.</p>
            </div>
        ...
        <section id="galeria" className="section gallery">
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>Un pequeño vistazo a la diversión que os espera en PequeMundo.</p>
            </div>
            ...
            <div className="gallery-button">
              <a href="#" className="btn btn-blue">📸 Ver más fotos</a>
            </div>
        ...
        <section id="precios" className="section pricing">
          <div className="container">
            ...
            <div className="section-title">
              ...
              <p>Diferentes opciones para adaptarnos a cada tipo de celebración.</p>
            </div>
  ...
  <div className="container why-grid">
    ...
    <div className="why-content">
      ...
      <p>
        Queremos que tanto los niños como los adultos disfruten de la celebración.
        Por eso cuidamos cada detalle para que vosotros solo tengáis que preocuparos
        de pasarlo bien.
      </p>
...
<section id="reserva" className="section reservation">
  ...
  <div className="container reservation-grid">
    ...
    <div className="reservation-form">
      ...
      <p>Completa el formulario y te confirmaremos la disponibilidad.</p>
      ...
      <form action="/api/reservations" method="POST">
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input type="tel" id="phone" name="phone" placeholder="600 000 000" required />
          </div>
          ...
          <div className="form-group">
            ...
            <select id="room" name="room" required>
              ...
              <option value="aventura">Sala Aventura</option>
              <option value="fantasia">Sala Fantasía</option>
              <option value="fiesta">Sala Fiesta</option>
            </select>
          </div>

          <div className="form-group">
            <label htmlFor="children">Número de niños</label>
            <input type="number" id="children" name="children" min="1" max="50" placeholder="Ej. 15" required />
          </div>

          <div className="form-group full">
            <label htmlFor="message">Mensaje adicional</label>
            <textarea id="message" name="message" rows="4" placeholder="Cuéntanos cualquier detalle..." />
          </div>
    ...
    <aside className="reservation-info">
      ...
      <div className="step">
        ...
        <div>
          ...
          <p>Selecciona el día y la hora que prefieras para tu evento.</p>
        </div>
      </div>
  ...
  <div className="container">
    ...
    <div className="contact-grid">
      ...
      <article className="contact-card">
        ...
        <h3>Dirección</h3>
        <p>Calle PequeMundo<br />28000 Madrid</p>
      </article>
